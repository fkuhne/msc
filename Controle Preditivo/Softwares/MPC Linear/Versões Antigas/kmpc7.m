...
%
% A linearizacao NAO VARIA dentro do horizonte de
% predicao, ou seja em dado k, o modelo linearizado
% (A(k+N),B(k+N)) eh o mesmo para todo N.
%
