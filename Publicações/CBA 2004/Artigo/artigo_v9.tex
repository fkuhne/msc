...
\subsection{Extensão do filtro de Kalman para sistemas não lineares}
	Um dos requisitos para a utilização do filtro de Kalman é que o sistema seja linear. Como este não é o caso, algum tipo de linearização pode ser usada \cite{mutambara1}. Assim, seja a estimativa do estado dada por:
\begin{equation*}
