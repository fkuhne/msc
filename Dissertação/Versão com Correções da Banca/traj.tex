...
O problema aqui é bastante parecido com o tratado no capítulo anterior, quando o objetivo era estabilizar o robô na origem. A diferença é que agora o objetivo é fazer com que o robô siga uma trajetória de referência pré determinada e variante no tempo, que pode ser formulado então como:
...
\begin{equation*}
	\left\{
		\begin{aligned}
			...
			y_{ref}(k+1) 	   &= y_{ref}(k) + v_{ref}(k)\sen\theta_{ref}(k)T \\
...
\begin{equation*}
	{\cal C}=\begin{bmatrix}
		\cos\theta_{ref} & 0 & 0 & -v_{ref}\sen\theta_{ref} & 0 & 0 \\
		\sen\theta_{ref} & 0 & 0 & v_{ref}\cos\theta_{ref} & 0 & 0 \\
		0 & 1 & 0 & 0 & 0 & 0
	\end{bmatrix}
\end{equation*}
...
\begin{equation*}
	{\bf A}(k) = \begin{bmatrix}
		1 & 0 & -v_{ref}(k)\sen\theta_{ref}(k)T \\
