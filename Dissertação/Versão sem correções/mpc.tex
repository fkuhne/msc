...
A expressão~\req{eqn:quadratic_form2} é a forma padrão para se aplicar um algoritmo de QP. Assim, o seguinte problema de otimização é resolvido em cada instante de amostragem $k$:
\begin{equation*}
